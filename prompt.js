...
class PromptBot {
    ...
    async onTurn(turnContext) {
        ...
        if (turnContext.activity.type === ActivityTypes.Message) {
            ...
            await PromptBot.fillOutUserProfile(flow, profile, turnContext);
    ...
    static async fillOutUserProfile(flow, profile, turnContext) {
        ...
        case question.age:
            ...
            if (result.success) {
                ...
                await turnContext.sendActivity(
                    `I have your age as ${ profile.age }.`
                );
        ...
        case question.date:
            ...
            if (result.success) {
                ...
                await turnContext.sendActivity(
                    `Your cab ride to the airport is scheduled for ${
                        profile.date
                    }.`
                );
                await turnContext.sendActivity(
                    `Thanks for completing the booking ${ profile.name }.`
                );
                await turnContext.sendActivity(
...
module.exports.MyBot = PromptBot;
